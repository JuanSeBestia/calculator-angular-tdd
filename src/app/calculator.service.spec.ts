...
describe('CalculatorService', () => {
  ...
  it('should have a function that cleans the currentValue', () => {
    const service: CalculatorService = TestBed.get(CalculatorService);
    expect(service.clean != undefined).toBeTruthy();
  });


  it('should clean the currentValue value and let it empty', () => {
    const service: CalculatorService = TestBed.get(CalculatorService);
    let value = "124";
    service.setCurrentValue(value);
    expect(service.clean() === "").toBe(true);
  });
});
